...
public extension Response {
     ...
     */
  func mapObject<T:Decodable>(rootKey: String? = nil) throws -> T where T == T.DecodedType {
  ...
  func mapObjectWithRootKey<T:Decodable>(rootKey: String) throws -> T where T == T.DecodedType {
     ...
     */
  func mapArray<T:Decodable>(rootKey: String? = nil) throws -> [T] where T == T.DecodedType {
  ...
  func mapArrayWithRootKey<T:Decodable>(rootKey: String) throws -> [T] where T == T.DecodedType {
